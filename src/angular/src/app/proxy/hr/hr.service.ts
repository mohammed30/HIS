import type { AttendanceRecordDto, CompensationItemDto, CreateUpdateAttendanceRecordDto, CreateUpdateCompensationItemDto, CreateUpdateEmployeeDto, CreateUpdateEmployeeLeaveDto, CreateUpdateEmployeeLoanDto, CreateUpdateJobGradeDto, CreateUpdateLeaveTypeDto, CreateUpdatePenaltyDto, CreateUpdateSalarySetupDto, EmployeeDto, EmployeeLeaveDto, EmployeeLoanDto, EmployeeLookupDto, JobGradeDto, LeaveTypeDto, PaySlipDto, PayrollRunDto, PenaltyDto, ProcessPayrollDto, SalarySetupDto } from './models';
