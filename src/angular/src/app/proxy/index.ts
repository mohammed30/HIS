...
export { Accounting, ActivityLogs, Appointments, Billing, Clinical, Dashboard, Emergency, General, Hr, Inpatient, Insurance, Inventory, Laboratory, MedicalRecords, Nursing, Operations, Patients, Pharmacy, Pricing, Rooms, Services, Settings };
