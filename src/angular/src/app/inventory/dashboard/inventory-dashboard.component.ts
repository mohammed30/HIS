...
export class InventoryDashboardComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        const streamCreator = (query) => {
            ...
            return this.inventoryService.getStockLevels(
                ...
                this.selectedType !== null && this.selectedType !== undefined ? this.selectedType : undefined
            ).pipe(
                tap(response => {
                    this.data = response;
    ...
    openTransferModal() {
        ...
        if (this.selectedWarehouseId) {
            this.inventoryService.getStockLevels(this.selectedWarehouseId, undefined, undefined).subscribe(res => {
