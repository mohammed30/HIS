...
import { NationalityDto } from '../../proxy/general/models';
            ...
            <div class="modal-content shadow-lg border-0">
              <div class="modal-header">
                <h5 class="modal-title">
                  <i class="fas fa-globe me-2"></i>
                  {{ editingItem ? 'تعديل - Edit' : 'إضافة - Add' }} جنسية - Nationality
                </h5>
              ...
              <div class="modal-body p-4">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" [(ngModel)]="formData.nameAr" required placeholder="مثلاً: مصرية">
                </div>
                @if (editingItem) {
                  <div class="mb-3">
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info text-white px-4" (click)="save()" [disabled]="loading || !formData.nameAr">
...
export class NationalitiesComponent implements OnInit {
  ...
  items: NationalityDto[] = [];
  searchText = '';
  showForm = false;
  editingItem: NationalityDto | null = null;
