            ...
            <table class="table table-hover align-middle border-top">
              <thead class="bg-light">
                <tr class="text-secondary small text-uppercase">
                  ...
                  <th style="width: 60%">الاسم (عربي) - Name (Ar)</th>
            ...
            <div class="modal-content border-0 shadow-2xl">
              <div class="modal-header border-0 pb-0">
                <h5 class="modal-title fw-bold d-flex align-items-center">
                  <span class="text-primary rounded p-2 me-3">
              ...
              <div class="modal-footer border-0 p-3 rounded-bottom-4">
                ...
                <button type="button" class="btn btn-primary px-5 shadow-sm rounded-3" (click)="save()" [disabled]="loading || !formData.nameAr">
                  @if (loading) {
