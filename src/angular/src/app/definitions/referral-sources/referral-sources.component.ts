        ...
        <div class="modal fade show d-block" style="background: rgba(15, 23, 42, 0.7); backdrop-filter: blur(4px); z-index: 1060;">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-2xl overflow-hidden">
              ...
              <div class="modal-body p-4 pt-4 text-dark bg-white">
                <div class="mb-4">
                  <label class="form-label fw-bold small text-uppercase text-secondary">الاسم (عربي) - Name (Ar) *</label>
                  <input type="text" class="form-control form-control-lg border-light bg-light text-dark" 
                         [(ngModel)]="formData.nameAr" required placeholder="مثلاً: مستشفى السلام">
                </div>
                <div class="mb-4">
                  <label class="form-label fw-bold small text-uppercase text-secondary">الاسم (إنجليزي) - Name (En) *</label>
                  <input type="text" class="form-control form-control-lg border-light bg-light text-dark" 
                         [(ngModel)]="formData.nameEn" required placeholder="e.g., Al Salam Hospital">
                </div>
                <div class="row align-items-center g-3">
                  <div class="col-8">
                    <label class="form-label fw-bold small text-uppercase text-secondary">{{ '::Code' | abpLocalization }}</label>
                    <input type="text" class="form-control border-light bg-light text-dark" 
              ...
              <div class="modal-footer border-0 p-4 bg-light shadow-inner">
                ...
                <button type="button" class="btn btn-danger px-5 rounded-pill fw-bold shadow" (click)="save()" [disabled]="loading || !formData.nameAr || !formData.nameEn">
                  @if (loading) {
