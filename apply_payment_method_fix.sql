-- FIX SCRIPT FOR MISSING PaymentMethodId COLUMN
-- Run this script on your Azure SQL Database

BEGIN TRANSACTION;

BEGIN TRY
    -- 1. Check if we need to rename PatientCategoryId -> PaymentMethodId
    ...
    -- 4. Add the new foreign key constraint (if not exists)
